...
# project_name="KickvsPunch_Grid_search"
project_name="KickvsPunch_Grid_search_longformer"
path='/homes/soxuxiee/GatedTransformerNetwork-Bachelor-Thesis--1/dataset/KickvsPunch.mat'
plot_folder_dir="./pic" 
